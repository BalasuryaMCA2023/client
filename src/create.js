...
export default function Create(){
    ...
    function handleSubmit(e){
      ...
      //   let data=[...userData,{id:accountNo,name:name,email:email,password:password,amount:amount}];
         ...
         axios.post("https://bank-server-2.onrender.com/create",data)
...
<>
    <Form  onSubmit={handleSubmit}  >
      <h4 id="Heading">Create Bank Account</h4><hr></hr>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label id="label"  >Account No:</Form.Label>
        <Form.Control type="number"  id="input"  required  onChange={(e)=>{setAccountNo(e.target.value)}}  />
        <Form.Label id="label" >User Name:</Form.Label>
        <Form.Control type="text" id="input"  required onChange={(e)=>{setName(e.target.value)}}  />
        <Form.Label id="label" >Email:</Form.Label>
        <Form.Control type="email" id="input"  required onChange={(e)=>{setEmail(e.target.value)}}  />
        <Form.Label id="label" >Password:</Form.Label>
        <Form.Control type="password" id="input"  required onChange={(e)=>{setPassword(e.target.value)}}/>
        <Form.Label id="label" >First Amount</Form.Label>
        <Form.Control type="number" id="input"  required onChange={(e)=>{setAmount(e.target.value)}}  />
